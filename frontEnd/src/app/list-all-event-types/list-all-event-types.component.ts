...
export class ListAllEventTypesComponent {
  ...
  goToCalendar(event){
    ...
    window.open(`http://localhost:3000/calendarLink/sharable?name=${this.loggedInName}&id=${this.loggedInEmailId}&evType=${event.evType}&evName=${event.evName}&evDurHrs=${event.evDuration.hrs}&evDurMins=${event.evDuration.minutes}`)
  }
