...
@Component({
  selector: 'app-meetings-table-admin',
  templateUrl: './meetings-table-admin.component.html',
  styleUrl: './meetings-table-admin.component.css'
})
export class MeetingsTableAdminComponent {
